...
<main class="bg-slate-50 min-h-screen px-12 py-8">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="/national-health-db/admin/users/add" class="bg-blue-500 hover:bg-blue-600 text-white px-5 py-2 rounded-xl text-sm font-semibold flex items-center space-x-2 shadow-sm transition">
                            ...
                            <tr class="hover:bg-slate-50/50 transition">
                                ...
                                <td class="px-6 py-4.5">
                                    <div class="flex justify-center items-center space-x-2">
                                        <a href="/national-health-db/admin/users/<?= $u['id'] ?>/edit" class="border border-blue-400 text-blue-500 hover:bg-blue-50 p-1.5 rounded-lg transition">
                                            <i class="fa-regular fa-pen-to-square text-sm"></i>
                                        </a>
                                        <form action="/national-health-db/admin/users/<?= $u['id'] ?>/delete" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this user?');">
                                            <button type="submit" class="border border-red-400 text-red-500 hover:bg-red-50 p-1.5 rounded-lg transition">
