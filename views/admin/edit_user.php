...
<main class="bg-slate-50 min-h-screen px-12 py-8 flex flex-col items-center justify-center">
    ...
    <div class="bg-white border border-gray-100 rounded-3xl p-8 shadow-sm w-full max-w-lg transition-all">
        ...
        <form action="/national-health-db/admin/users/<?= $user['id']; ?>/edit" method="POST" class="space-y-5">            
            <div>
            ...
            <div class="flex items-center space-x-3 pt-4">
                <a href="/national-health-db/admin/users" 
